...
//from jio.brain.proto.knowledge.healthcare.req_res.get_all_disease_pb2 import GetAllFluidResponse......
import copy

class GetAllFluidWorker:
    ...
    def transform_request(self, request):
        ...
        knowledge_request = {"predicate_name": "is_a", "from_node": "hydrocarbon_fluid"}
    ...
    def transform_response(self, response, status):
        ...
        if not response:
            response = GetAllFluidResponse(status = status)        
        else:
            response_obj = []
